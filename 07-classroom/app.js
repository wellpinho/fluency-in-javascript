...
for (let i = 0; i < randomValues.length; i++) {
  ...
  messages.push(randomValues[i]);
}

console.log(`
  - As primeiras 4 strings são ${messages.join(', ').replace(', ,', ' e')}
  - Até que as primeiras 4 strings fossem iteradas, ${messages.indexOf(false)} booleans foram iterados;
  - O array foi iterado por ${messages.length} vezes.
`)
/*
  06
