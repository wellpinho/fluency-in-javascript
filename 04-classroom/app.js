...
*/
const my3FavoriteTVShows = ['Avatar', 'A rede Social', 'Jobs'];
...
*/
const compare = 39;
// console.log(`A string que a "typeSentence" armazena tem mais de ${compare} caracteres? ${String(typeSentence.length > compare).replace('t', 'T')}.`)
