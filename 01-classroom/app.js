...
// const printMessage = () => alert('JS is Awesome!');
...
(() => {
    ...
    */
    ...
    const myBirthYear = (age) => {
        const yearsOld = 2023 - age;
        return `My year of birth: ${yearsOld}`;
    }
    
    age.innerHTML = myBirthYear(44)
})();
...
(() => {
    ...
    */
    ...
    console.log('exercise 7: ', myBirthYear(43), currentYear())
...
(() => {
    ...
    */
    ...
    console.log(myAge(actualYear, age))
})();
...
(() => {
    ...
    */
    ...
    console.log(`Em ${2023 + ten}, estarei com ${44 + ten} anos.`)
})();
