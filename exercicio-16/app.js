...
elementsInsideDiv.forEach(element => {
  element.addEventListener('click', (event) => {
    ...
    console.log('Clicou no filho da div.', event.target.tagName)
  })
})
...
elementsInsideDiv.forEach(element => {
  element.addEventListener('click', () => {
    const nameUppercase = element.textContent.toLowerCase()

    console.log(`Clicou no ${nameUppercase}, filho da div.`)
  })
})
...
elementsInsideDiv.forEach(element => {
  element.addEventListener('click', () => {
    ...
    const nameUppercase = element.textContent.toLocaleUpperCase()

    h2.innerText = `Clicou no ${nameUppercase}, filho da div.`
  })
})
...
h2.addEventListener('copy', showClickedMessage)
...
const hasFrontendDevelopper = 
  people.some(({ profession }) => profession === 'Front-end developer')

if (hasFrontendDevelopper) {
