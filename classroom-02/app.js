...
// console.log(randomWord.length) ???? x
// console.log(randomWord[randomWord.length - 1]); v
...
// let newName = name.split(' ').map(char => char[0].toUpperCase()) ????
// let newName = name[0].toUpperCase() + nameslice(1, 6) + ' ' + name[7].toUpperCase() + name.slice(8)
// console.log(newName)
...
- Exiba a "newName" no console;
*/
console.log(`${name[0].toUpperCase()}${name.slice(1, 6)} ${name[7].toUpperCase()}${name.slice(8)}`)
